...
import com.example.categoryview.Model.Cart;
import com.example.categoryview.Prevalent.Prevalent;
import com.example.categoryview.ViewHolder.CartViewHolder;
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder holder, int position, @NonNull final Cart model) {
                ...
                int oneTypeProductPrice=(Integer.valueOf(getPrice));
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(i==0)
                                {
                                    Intent intent=new Intent(CartActivity.this,ProductDetailView.class);
